...
public class TelegramBot {
    ...
    public GetUpdatesResponse getUpdates(Integer offset, Integer timeout) {
        return botApi.getUpdates(offset, timeout);
    }
    ...
    public Replier replyTo(Update update) {
        return new Replier(this, update);
    }
}
